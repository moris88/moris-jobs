...
export default class Logger {
    ...
    start = () => {
        ...
        console.log(
            colors.bgCyan(
                colors.black(`${this.getDateNow()} Esecuzione iniziata`)
            )
        )
        ...
        console.log(
            colors.bgCyan(
                colors.black(`${this.getDateNow()} Esecuzione terminata`)
            )
        )
    ...
    info = (obj: any): void => {
        if (typeof obj === 'string') {
            ...
            console.log(
                colors.cyan(`${this.getDateNow()} ${JSON.stringify(obj)}`)
            )
    ...
    warn = (obj: any): void => {
        if (typeof obj === 'string') {
            console.log(
                colors.bgYellow(
                    colors.white(`${this.getDateNow()} WARNING! ${obj}`)
                )
            )
            ...
            console.log(
                colors.bgYellow(
                    colors.white(
                        `${this.getDateNow()} WARNING! ${JSON.stringify(obj)}`
                    )
                )
            )
            this.writeLog(
    ...
    error = (obj: any): void => {
        if (typeof obj === 'string') {
            ...
            console.log(
                colors.bgRed(
                    colors.white(
                        `${this.getDateNow()} ERROR! ${JSON.stringify(obj)}`
                    )
                )
            )
